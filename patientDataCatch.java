...
public class patientDataCatch extends JFrame implements ActionListener {
    ...
    patientDataCatch() throws SQLException {
    ...
    public void showTableData() {
       ...
       // from = (String) c1.getSelectedItem();
        ...
        try {
            pst = con.prepareStatement("select * from patient where ID='" + from + "'");
